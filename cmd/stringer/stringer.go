...
var (
	...
	samepkg     = flag.Bool("samepkg", false, "stringer and string2enum output in same package")
	enumpkg     = flag.Bool("enumpkg", false, "stringer and string2enum output in the enum package")
