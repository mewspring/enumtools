...
var (
	...
	samepkg     = flag.Bool("samepkg", false, "string2enum and enum2string output in same package")
	enumpkg     = flag.Bool("enumpkg", false, "string2enum and enum2string output in the enum package")
...
func %[1]sFromString(s string) (%[4]s, bool) {
	if len(s) == 0 {
		return 0, true // TODO: figure out how to handle empty string.
	}
...
// The boolean return value indicates success.
func %[1]sFromString(s string) (%[2]s, bool) {
	if len(s) == 0 {
		return 0, true // TODO: figure out how to handle empty string.
	}
`
